public class Mago extends Characters{
    //metodos del Mago
    public Mago(int fuerza, int destreza, int inteligencia, int carisma, int constitucion, int sabiduria, int mod_req_princ,String alineacion, int ataque, int golpe) {
