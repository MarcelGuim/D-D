public class Mediano extends Characters {
    //metodos del Mediano
    public Mediano(int fuerza, int destreza, int inteligencia, int carisma, int constitucion, int sabiduria, int mod_req_princ,String alineacion, int ataque, int golpe) {
